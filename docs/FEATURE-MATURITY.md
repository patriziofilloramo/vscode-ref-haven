...
| Rich current-line hover                           | Understand code | Stable     | Strong local alternative; no cloud enrichment by design                                                                                                                                             | Default-on, lazy, escaped, cancellable, revision-aware, and tested in Extension Host. Keep.                                                                                               |
| Current-line inline/status blame                  | Understand code | Stable     | Less visual customization than the leading baseline                                                                                                                                                 | Reliable and mode-controlled. Improve formatting options only when a concrete usability case justifies more settings.                                                                     |
...
| Changes-relative-to-ref annotations               | Review locally  | Beta       | No important privacy-related deficit                                                                                                                                                                | Useful but session-only and saved-buffer-only. Keep contextual; add visual evidence before promotion.                                                                                     |
| File and line history, readonly revisions         | Understand code | Stable     | No visual-history webview                                                                                                                                                                           | Native editors, rename following, pinned-revision hover, and revision URI security are tested. Keep.                                                                                      |
| Local commit search and details                   | Understand code | Beta       | Trails the leading baseline's regex and match controls for no privacy reason                                                                                                                        | Keep; add explicit query modes and tests before calling it complete.                                                                                                                      |
...
2. Add explicit query modes to local commit search.
3. Reassess inline/status formatting only after annotation Beta gates are closed.
4. Audit the matrix before every minor release and before advertising any new
   headline feature.
